...
test:
	gcc -DTESTING -Wall -Werror -Isrc -Iinclude -Itests tests/main.c src/initialization.c include/initialization.h src/prints.c include/prints.h include/typedefs.h include/definitions.h src/prng.c include/prng.h src/card_manip.c include/card_manip.h src/gameplay.c include/gameplay.h src/scoring.c include/scoring.h -o blackjack
test-debug:
	gcc -DTESTING -g -Wall -Werror -Isrc -Iinclude -Itests tests/main.c src/initialization.c include/initialization.h src/prints.c include/prints.h include/typedefs.h include/definitions.h src/prng.c include/prng.h src/card_manip.c include/card_manip.h src/gameplay.c include/gameplay.h src/scoring.c include/scoring.h -o blackjack
debug:
